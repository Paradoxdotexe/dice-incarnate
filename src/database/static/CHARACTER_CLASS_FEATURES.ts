...
export const CHARACTER_CLASS_FEATURES: CharacterClassFeature[] = [
  ...
  },
  {
    ...
    description:
      "While wielding this weapon in combat, your AC is increased by 1.",
    order: 3,
  ...
  },
  {
    ...
    description:
      "While wielding this weapon in combat, your Movement Speed is increased by 5ft.",
    order: 3,
    ascensionRequirement: 3,
  },
  {
  ...
  },
  {
    ...
    description:
      "While wielding this weapon, opportunity attacks against you have disadvantage.",
    order: 3,
    ascensionRequirement: 3,
  },
  {
